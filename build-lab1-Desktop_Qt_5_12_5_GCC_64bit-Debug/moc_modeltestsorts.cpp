...
#include "../../ProcessCalculusRemoveWork/pc-lab1-FirstProgrammerEfarovIlya/Efarov/modeltestsorts.h"
...
QT_MOC_LITERAL(4, 29, 12), // "updated_data"
QT_MOC_LITERAL(5, 42, 8), // "finished"
QT_MOC_LITERAL(6, 51, 4), // "test"
QT_MOC_LITERAL(7, 56, 9) // "stop_test"

    },
    "ModelTestSorts\0progress\0\0val\0updated_data\0"
    "finished\0test\0stop_test"
};
...
void ModelTestSorts::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModelTestSorts::updated_data)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ModelTestSorts::updated_data()
{
